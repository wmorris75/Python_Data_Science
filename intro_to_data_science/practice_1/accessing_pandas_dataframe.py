...
if True:
    ...
    print ""
    print football['year'][(football.wins > 10) & (football.team == "Packers")]
    print ""

    #equivalent function using map and apply. Note the applymap returns a dataframe object
    print football['wins'].map(lambda x: x > 1)
    print football.applymap(lambda x: x > 1)